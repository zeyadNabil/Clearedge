  ...
  private services: ServiceDetail[] = [
    {
      ...
      overview: 'While our core business has been commercial janitorial services, AHI offers a wide variety of ancillary services so we can be a full service solution for our customers.',
      mainHeading: 'Serving Fortune 500 Companies',
      mainDescription: 'While our core business has been commercial janitorial services, AHI offers a wide variety of ancillary services so we can be a full service solution for our customers. Our company is not just reactive, but proactive. We train our staff to actively tell customers of issues within and around their buildings to help prevent further issues or damage.',
      heroImageUrl: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=1920&q=80',
      serviceItems: [
        { title: 'Carpet & Floor Care Services', description: 'Get the best carpet and floor cleaning plus sanitation from AHI', imageUrl: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=800&q=80' },
        { title: 'Landscaping / Grounds Keeping', description: 'AHI Landscaping Maintenance uses proven quality control procedures to ensure your landscape is well maintained.', imageUrl: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=800&q=80' },
        { title: 'Parking Lot Sweeping & Striping', description: 'Give your customers and employees a safe and clean parking lot with AHI parking lot services.', imageUrl: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800&q=80' },
        { title: 'Window Washing / Power Washing', description: 'AHI\'s cleaning equipment is some of the latest in deionized window washing technology.', imageUrl: 'https://images.unsplash.com/photo-1563453392212-326f5e854473?w=800&q=80' },
        { title: 'Carpet & Tile Replacement', description: 'Get a custom, beautiful landscape from AHI that will show off your unique corporate style.', imageUrl: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&q=80' },
        { title: 'Construction Clean Up', description: 'Keep your worksite safe and clean with AHI clean up services.', imageUrl: 'https://images.unsplash.com/photo-1504303391375-e5e2293be34c?w=800&q=80' },
        { title: 'Garage Maintenance', description: 'AHI keeps your garages clean, well lit, and safe.', imageUrl: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&q=80' },
        { title: 'Document Shredding', description: 'Securely dispose of documents using AHI document shredding services.', imageUrl: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=800&q=80' },
        ...
        { title: 'Painting Services', description: 'AHI has painter technicians who specialize in getting your space painted quickly and easily.', imageUrl: 'https://images.unsplash.com/photo-1563453392212-326f5e854473?w=800&q=80' },
        { title: 'Recycle Programs', description: 'Help protect the environment and reduce waste hassle free through AHI\'s recycle programs.', imageUrl: 'https://images.unsplash.com/photo-1611262588024-d12430b98920?w=800&q=80' },
        { title: 'Re-Lamping', description: 'AHI can replace any light fixture bulbs regardless of placement or quantity.', imageUrl: 'https://images.unsplash.com/photo-1513475382585-d06e58bcb0e0?w=800&q=80' },
        { title: 'Floor Restoration', description: 'Get your floors shining like new again with AHI\'s professional floor restoration services. We can also perform tile and grout sealing', imageUrl: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&q=80' },
        { title: 'Carpet Cleaning', description: 'AHI\'s carpet cleaning staff are trained to get you cleanest carpets in the shortest amount of time.', imageUrl: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=800&q=80' },
        { title: 'Strip & Wax', description: 'AHI will properly strip and wax your floors to give it a glossy, protective layer that keeps your floors attractive and free from scratches.', imageUrl: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&q=80' },
        { title: 'High Dusting', description: 'AHI will fully dust your establishment, no matter how inaccessible it may seem.', imageUrl: 'https://images.unsplash.com/photo-1556911220-bff31c812dba?w=800&q=80' },
        { title: 'Pest Control', description: 'AHI\'s licensed pest control services removes any pests and keeps them from coming back.', imageUrl: 'https://images.unsplash.com/photo-1556911220-bff31c812dba?w=800&q=80' },
        { title: 'LEED', description: 'AHI\'s Sustainably Green program can help those interested in pursuing LEED certification.', imageUrl: 'https://images.unsplash.com/photo-1611262588024-d12430b98920?w=800&q=80' },
        { title: 'Warehouse and Power Plant Cleaning', description: 'AHI\'s specialists are trained in warehouse and power plant cleaning protocol. We are also fully trained in proper heavy machinery operation, such as shop floor degreasing, fork lifts, and large compactors.', imageUrl: 'https://images.unsplash.com/photo-1504303391375-e5e2293be34c?w=800&q=80' },
        { title: 'Event Services', description: 'Let AHI help you prepare your holiday event or office function.', imageUrl: 'https://images.unsplash.com/photo-1511578314322-379afb476865?w=800&q=80' },
        { title: 'Maintenance Person', description: 'AHI can provide you a maintenance person for all of your on site needs.', imageUrl: 'https://images.unsplash.com/photo-1504303391375-e5e2293be34c?w=800&q=80' },
        ...
        { title: 'Emergency and After Work Hours Services', description: 'From inclement weather to pipe breaks, AHI can be on site during evenings and weekends.', imageUrl: 'https://images.unsplash.com/photo-1504303391375-e5e2293be34c?w=800&q=80' },
        { title: 'Multi-tier Supervision', description: 'AHI strongly believes that multiple sets of eyes are required to engulf and manage all cleaning needs.', imageUrl: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&q=80' }
      ],
      facilityTypes: [
    ...
    },
    {
      ...
      mainDescription: 'Your customers, clients, and employees form an impression about your property based on the visual impact of the surrounding landscape and curb appeal. At AHI Landscape Maintenance, we use our proven management methods, quality control procedures, and knowledgeable staff to ensure your landscaping is healthy and well maintained.',
      heroImageUrl: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=1920&q=80',
      serviceItems: [
        { title: 'Landscaping Services', description: 'AHI Landscaping Maintenance uses proven quality control procedures to ensure your landscape is well maintained.', imageUrl: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=800&q=80' },
        ...
        { title: 'Irrigation Design Build', description: 'AHI Employs a licensed irrigator to perform service, system checks, and help maintain your irrigation system.', imageUrl: 'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=800&q=80' },
        { title: 'Sprinkler Services', description: 'Your landscape will water itself with sprinkler services from AHI.', imageUrl: 'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=800&q=80' },
        { title: 'Landscape Installation', description: 'Get a custom, beautiful landscape from AHI that will show off your unique corporate style.', imageUrl: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=800&q=80' },
    ...
    },
    {
      ...
      overview: 'Whether your concerns are viable particles or potential yield increases, AHI Facility Services, Inc. will develop a program to give you control.',
      mainHeading: 'The Cleanroom & Data Center Cleaning Experts',
      mainDescription: 'Whether your concerns are viable particles or potential yield increases, AHI Facility Services, Inc. will develop a program to give you control. AHI is committed to providing cleanroom and data center cleaning services that meet the highest standards of cleanliness and contamination control.',
      heroImageUrl: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=1920&q=80',
      serviceItems: [
        { title: 'Cleanroom Protocol', description: 'AHI\'s certified technicians are tested in cleanroom protocol cleaning', imageUrl: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=800&q=80' },
        { title: 'Trusted Experience', description: 'AHI currently does business with many types of cleanroom and production environments, such as aerospace, biotechnology, and pharmaceutical facilities.', imageUrl: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=800&q=80' },
